...
//
//	mockgen -source=handler.go -destination=mocks/mock_hello.go -package=mocks
//
...
func (m *MockHelloService) GetDBStatus(ctx context.Context) string {
	m.ctrl.T.Helper()
...
func (mr *MockHelloServiceMockRecorder) GetDBStatus(ctx any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetDBStatus", reflect.TypeOf((*MockHelloService)(nil).GetDBStatus), ctx)
}
